...
import { Phone, Menu, X, ArrowUpRight, Plus, Eye, ShoppingBag } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            <a
              href="#calculator"
              className="px-4 py-2 text-xs font-semibold rounded-full border border-black/15 bg-white text-obsidian-900 hover:border-black/40 hover:bg-neutral-50 transition tracking-wide flex items-center space-x-1 shadow-xs"
            >
              <span>Customize</span>
            ...
            <a
              href="#best-sellers"
              className="px-3.5 py-2 rounded-full bg-white border border-blue-200/80 hover:border-blue-300 transition flex items-center space-x-1.5 shadow-xs text-xs font-semibold text-obsidian-900"
              title="Store Cart"
            >
