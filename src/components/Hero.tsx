        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 lg:space-y-8 z-10">
            ...
            <div className="relative">
              <h1 className="font-serif text-4xl sm:text-6xl lg:text-7xl font-light tracking-tight text-obsidian-900 leading-[1.1] sm:leading-[1.08]">
                SEE THE <br />
              ...
              {/* Subtitle */}
              <p className="mt-4 sm:mt-5 text-sm sm:text-lg text-neutral-600 max-w-xl font-normal leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1 sm:pt-2">
              <a
                href="#relensing"
                className="px-6 sm:px-7 py-3.5 rounded-full bg-obsidian-900 text-white font-medium text-xs sm:text-sm hover:bg-neutral-800 transition shadow-elevated flex items-center justify-center group"
              >
                <span>Re-Lens Existing Frames</span>
                <div className="ml-2 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-white/10 flex items-center justify-center transition-transform group-hover:translate-x-0.5">
              ...
              <div className="flex items-center gap-2">
                <a
                  href="#best-sellers"
                  className="flex-1 sm:flex-initial text-center px-5 sm:px-6 py-3.5 rounded-full bg-white border border-black/10 font-medium text-xs sm:text-sm text-neutral-800 hover:border-black/30 transition shadow-sm"
                >
                  Explore Eyewear
                </a>

                <div className="px-3 py-2 rounded-full bg-cream-200/80 text-xs text-neutral-600 font-medium flex items-center space-x-1">
                  <span className="text-[11px]">From</span>
                  <span className="font-bold text-obsidian-900 text-xs">$49</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[480px]">
              ...
              <div className="absolute -top-3 sm:-top-4 -left-2 sm:-left-8 z-30 bg-white/95 backdrop-blur-md px-3 sm:px-4 py-2 sm:py-2.5 rounded-2xl shadow-card border border-black/5 animate-float-slow max-w-[210px] sm:max-w-none">
                <div className="flex items-center space-x-1.5 text-[10px] sm:text-[11px] font-bold text-accent-sky uppercase tracking-wider">
                  <span className="w-2 h-2 rounded-full bg-accent-sky animate-ping" />
                  <span>PRO LENS LAB</span>
                </div>
                <div className="text-[11px] sm:text-xs font-semibold text-obsidian-900 mt-0.5">
                  The Ultimate Duo — Clarity & Confidence
                </div>
              </div>

              {/* Floating Price Pill: '$49' */}
              <div className="absolute top-24 sm:top-28 -left-2 sm:-left-6 z-30 bg-obsidian-900 text-white px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-full shadow-elevated text-[11px] sm:text-xs font-bold border border-white/10 animate-float-delayed">
                From $49
              </div>
              ...
              <div className="relative rounded-[32px] p-2 bg-gradient-to-b from-white to-[#E8E4DC] shadow-elevated">
                <div className="relative overflow-hidden rounded-[26px] cut-corner-card bg-neutral-200 aspect-[4/5]">
                  ...
                  <div className="absolute bottom-3 sm:bottom-4 inset-x-3 sm:inset-x-4 bg-white/90 backdrop-blur-md p-2.5 sm:p-3.5 rounded-2xl border border-black/5 shadow-card flex items-center justify-between">
                    <div>
                      <div className="text-[10px] sm:text-[11px] font-bold tracking-wider uppercase text-neutral-500">
                        In-House Optician
                      </div>
                      <div className="text-[11px] sm:text-xs font-bold text-obsidian-900">
                        Mauricio's Precision Fitting
                      </div>
                    </div>
                    <span className="text-[10px] sm:text-[11px] font-semibold px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full bg-accent-gold/15 text-neutral-900">
                      Freeport, NY
                    </span>
                  </div>
                </div>
              ...
              <div className="absolute -bottom-5 sm:-bottom-6 right-1 sm:-right-6 z-30 bg-white/95 backdrop-blur-md p-2.5 sm:p-3.5 rounded-2xl shadow-elevated border border-black/5 max-w-[190px] sm:max-w-[220px]">
                <div className="flex items-center space-x-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-accent-gold/20 flex items-center justify-center text-accent-gold font-bold text-xs flex-shrink-0">
                    RL
                  </div>
                  <div>
